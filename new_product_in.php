...
<head>
    ...
    <title>Lavinia Shop - Add New Product In</title>
    <style>
...
<body>
    ...
    <form action="./new_product_in.php" method="post">
        ...
        <input type="submit" value="Add Product In">
    </form>
    <?php
// Database connection parameters
include('./connection.php');
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insert new product in record into the database
    $sql = "INSERT INTO productin (ProductCode, Date, Quantity, UniquePrice, TotalPrice) VALUES ('$productCode', '$date', '$quantity', '$uniquePrice', '$totalPrice')";

    if ($conn->query($sql) === TRUE) {
        echo "New product in record added successfully!";
